...
namespace Microsoft.ML.Probabilistic.Distributions
{
    ...
    /// </summary>
    public class CollectionElementMappingInfo //: List<Tuple<List<int>, List<int>>>
    {
        private List<Tuple<List<int>, List<int>>> elementMapping;
        ...
        ICollectionDistribution
    {
        ...
        ICollectionDistribution<TElement, TNewElementDist> TransformElements<TNewElementDist>(Func<object, object> transformFunc)
