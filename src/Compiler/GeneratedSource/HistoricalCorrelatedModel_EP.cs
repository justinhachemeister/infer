...
namespace Models
{
	public partial class HistoricalCorrelatedModel_EP : IGeneratedAlgorithm
	{
		#region Fields
		...
		public bool vbool____3_reduced;
		#endregion
						...
						for(int game_inBlock2 = 0; game_inBlock2<GamesInBlock[game_thread2][game_Block2].Length; game_inBlock2++) {
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								if (!thisDotnoExperienceLastGameInConditions_game_playerInGame_local) {
									...
									Gaussian thisDotvdouble226_F_game_playerInGame_local = default(Gaussian);
									...
									thisDotvdouble226_F_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotpredictedSkill1_F_game_playerInGame_local, this.skillOffsetChangeMeanByExperience[thisDotplayerConditionsToLearnInGame_game_playerInGame_local][thisDotboundedExperienceForConditions_game_local[playerInGame]]);
									thisDotpredictedSkill2_1__F_game_playerInGame_local = GaussianOpBase.SampleAverageConditional(thisDotvdouble226_F_game_playerInGame_local, this.skillOffsetChangePrecisionPerGame[thisDotplayerConditionsToLearnInGame_game_playerInGame_local]);
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								for(int index16 = 0; index16<thisDotupdateChangeVariableSubarrayCountInGame_game_playerInGame_local; index16++) {
									thisDotupdateChanges_F_game_playerInGame_local[index16] = Gaussian.Uniform();
								}
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								for(int index15 = 0; index15<thisDotpreviousChangeVariableSubarrayCountInGame_game_playerInGame_local; index15++) {
									thisDotpreviousChanges_F_game_playerInGame_local[index15] = Gaussian.Uniform();
								}
							...
							DistributionStructArray<Gaussian,double> thisDotvdouble230_F_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble230_F_game_local = new DistributionStructArray<Gaussian,double>(this.playerCountInGame[game]);
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian thisDotvdouble230_F_game_playerInGame_local = default(Gaussian);
								thisDotvdouble230_F_game_playerInGame_local = FastSumOp.SumAverageConditional(thisDotpreviousChanges_F_game_local[playerInGame]);
								thisDotvdouble230_F_game_local[playerInGame] = thisDotvdouble230_F_game_playerInGame_local;
							}
							DistributionStructArray<Gaussian,double> thisDotvdouble231_F_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble231_F_game_local = new DistributionStructArray<Gaussian,double>(this.playerCountInGame[game]);
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian thisDotvdouble231_F_game_playerInGame_local = default(Gaussian);
								thisDotvdouble231_F_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotbaseSkillChangePrimary_F_game_local[playerInGame], thisDotvdouble230_F_game_local[playerInGame]);
								thisDotvdouble231_F_game_local[playerInGame] = thisDotvdouble231_F_game_playerInGame_local;
							}
							DistributionStructArray<Gaussian,double> thisDotvdouble247_F_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble247_F_game_local = new DistributionStructArray<Gaussian,double>(this.playerCountInGame[game]);
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								Gaussian thisDotvdouble231_F_game_playerInGame_local2 = default(Gaussian);
								thisDotvdouble231_F_game_playerInGame_local2 = thisDotvdouble231_F_game_local[playerInGame];
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local3==4) {
									Gaussian thisDotbaseSkillChangeSinceLastGame_4__F_game_playerInGame_local = default(Gaussian);
									thisDotbaseSkillChangeSinceLastGame_4__F_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotvdouble231_F_game_playerInGame_local2, thisDotupdateChanges_playerInGame_1_4__uses_F_game_playerInGame__1_local);
								...
								Gaussian thisDotvdouble247_F_game_playerInGame_local = default(Gaussian);
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local3==0) {
									thisDotbaseSkillChangeSinceLastGame_F_game_playerInGame_local = ArrayHelper.SetTo<Gaussian>(thisDotbaseSkillChangeSinceLastGame_F_game_playerInGame_local, thisDotvdouble231_F_game_playerInGame_local2);
								}
								...
								thisDotvdouble247_F_game_playerInGame_local = GaussianProductOpBase.ProductAverageConditional(thisDotbaseSkillChangeSinceLastGame_F_game_playerInGame_local, this.baseSkillWeights[thisDotplayerConditionsToLearnInGame_game_local[playerInGame]]);
								thisDotvdouble247_F_game_local[playerInGame] = thisDotvdouble247_F_game_playerInGame_local;
							}
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								thisDotpredictedSkill_F_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotpredictedSkill2_F_game_local[playerInGame], thisDotvdouble247_F_game_local[playerInGame]);
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								if (this.playerIsInSquad[game][playerInGame]) {
									int thisDotvint147_game_playerInGame_local = default(int);
									thisDotvint147_game_playerInGame_local = Factor.Difference(this.squadSizeBucketCount[thisDotplayerConditionsToLearnInGame_game_local[playerInGame]], 1);
									...
									thisDotboundedSquadSize_game_local[playerInGame] = Math.Min(thisDotvint147_game_playerInGame_local, thisDotSquadSizeMinus2_game_playerInGame_local);
								}
							}
							Gaussian[][] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_local = default(Gaussian[][]);
							thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_local = new Gaussian[this.playerCountInGame[game]][];
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian[] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local = default(Gaussian[]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local = new Gaussian[2];
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local[0] = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local;
							}
							DistributionStructArray<Gaussian,double> thisDotvdouble__146_F_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble__146_F_game_local = new DistributionStructArray<Gaussian,double>(thisDotTeamCount_game_local);
							for(int team = 0; team<thisDotTeamCount_game_local; team++) {
								thisDotvdouble__146_F_game_local[team] = Gaussian.Uniform();
							}
							DistributionStructArray<Gaussian,double> thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_game_local = new DistributionStructArray<Gaussian,double>(this.playerCountInGame[game]);
							Gaussian[][] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_local = default(Gaussian[][]);
							thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_local = new Gaussian[this.playerCountInGame[game]][];
							DistributionStructArray<Gaussian,double> thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_game_local = new DistributionStructArray<Gaussian,double>(this.playerCountInGame[game]);
							DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_local = default(DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>);
							thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_local = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.playerCountInGame[game]);
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								DistributionStructArray<Gaussian,double> thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_local = default(DistributionStructArray<Gaussian,double>);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_local = new DistributionStructArray<Gaussian,double>(this.eventTypeCount);
								for(int eventType = 0; eventType<this.eventTypeCount; eventType++) {
									Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_eventType_local = LowPriorityBackwardOp.ValueAverageConditional<Gaussian>(this.enemyAverageCopy_B[game][playerInGame][eventType]);
									thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_local[eventType] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_eventType_local;
								}
								Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_game_playerInGame_local = default(Gaussian);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_game_playerInGame_local = ReplicateOp_Divide.ToDefInit<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_local[playerInGame][0]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_game_playerInGame_local = ReplicateOp_Divide.ToDef<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_local, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_game_playerInGame_local);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_local;
								Gaussian[] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local = default(Gaussian[]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local = new Gaussian[2];
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local[0] = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local[1] = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local[0] = ArrayHelper.SetTo<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local[0], thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_game_playerInGame_local);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_game_playerInGame_local;
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local[1] = LowPriorityBackwardOp.ValueAverageConditional<Gaussian>(this.enemyAverageQuit_B[game][playerInGame]);
								Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_game_playerInGame_local = default(Gaussian);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_game_playerInGame_local = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_game_playerInGame_local = ReplicateOp_NoDivide.DefAverageConditional<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_game_playerInGame_local);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_game_playerInGame_local;
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local;
							}
							DistributionStructArray<Gaussian,double> thisDotvdouble__146_F_marginal_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble__146_F_marginal_game_local = GetItemsOp<double>.MarginalInit<DistributionStructArray<Gaussian,double>>(thisDotvdouble__146_F_game_local);
							DistributionStructArray<Gaussian,double> thisDotvdouble__146_B_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble__146_B_game_local = new DistributionStructArray<Gaussian,double>(thisDotTeamCount_game_local);
							for(int team = 0; team<thisDotTeamCount_game_local; team++) {
								thisDotvdouble__146_B_game_local[team] = Gaussian.Uniform();
							}
							thisDotvdouble__146_B_game_local = GetItemsOp<double>.ArrayAverageConditional<Gaussian,DistributionStructArray<Gaussian,double>>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_game_local, thisDotteamIndexOfPlayer_game_local, thisDotvdouble__146_B_game_local);
							...
							for(int team = 0; team<thisDotTeamCount_game_local; team++) {
								thisDotteamStrength2_rep_B_game_local[team] = SumExceptOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(thisDotvdouble__146_B_game_local[team], this.teamStrength2_rep_F[game][team], team, thisDotteamStrength2_rep_B_game_local[team]);
							}
							...
							for(int orderedTeam = 0; orderedTeam<thisDotTeamCount_game_local; orderedTeam++) {
								...
								if (orderedTeam>0) {
									...
									if (thisDotdrawWithPreviousInGame_game_orderedTeam_local) {
										double thisDotvdouble305_game_orderedTeam_local = default(double);
										thisDotvdouble305_game_orderedTeam_local = Factor.Difference(0.0, thisDotdrawMargin_thisDotdrawMarginConditionsInGame_game_local);
										Gaussian thisDotPerformanceDifference_0__B_game_orderedTeam_local = default(Gaussian);
										thisDotPerformanceDifference_0__B_game_orderedTeam_local = DoubleIsBetweenOp.XAverageConditional(true, thisDotPerformanceDifference_F_game_orderedTeam_local, thisDotvdouble305_game_orderedTeam_local, thisDotdrawMargin_thisDotdrawMarginConditionsInGame_game_local);
							...
							for(int orderedTeam = thisDotTeamCount_game_local-1; orderedTeam>=0; orderedTeam--) {
								...
								if (orderedTeam>0) {
									...
									if (thisDotdrawWithPreviousInGame_game_orderedTeam_local2) {
										double thisDotvdouble305_RorderedTeam_game_orderedTeam_local = default(double);
										thisDotvdouble305_RorderedTeam_game_orderedTeam_local = Factor.Difference(0.0, thisDotdrawMargin_thisDotdrawMarginConditionsInGame_game_local);
										Gaussian thisDotPerformanceDifference_0__B_RorderedTeam_game_orderedTeam_local = default(Gaussian);
										thisDotPerformanceDifference_0__B_RorderedTeam_game_orderedTeam_local = DoubleIsBetweenOp.XAverageConditional(true, thisDotPerformanceDifference_F_RorderedTeam_game_orderedTeam_local, thisDotvdouble305_RorderedTeam_game_orderedTeam_local, thisDotdrawMargin_thisDotdrawMarginConditionsInGame_game_local);
							...
							for(int team = 0; team<thisDotTeamCount_game_local; team++) {
								thisDotvdouble__146_F_game_local[team] = SumExceptOp.SumExceptAverageConditional(this.teamStrength2_rep_F[game][team], team);
							}
							thisDotvdouble__146_F_marginal_game_local = GetItemsOp<double>.Marginal<DistributionStructArray<Gaussian,double>,Gaussian>(thisDotvdouble__146_F_game_local, thisDotvdouble__146_B_game_local, thisDotvdouble__146_F_marginal_game_local);
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								Gaussian[] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2 = default(Gaussian[]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2 = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_local[playerInGame];
								Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_marginal_game_playerInGame_local = default(Gaussian);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_marginal_game_playerInGame_local = ReplicateOp_Divide.MarginalInit<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2[0]);
								Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_game_playerInGame_local = default(Gaussian);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_game_playerInGame_local = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_game_playerInGame_local = GetItemsOp<double>.ItemsAverageConditional<DistributionStructArray<Gaussian,double>,Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_game_local[playerInGame], thisDotvdouble__146_F_game_local, thisDotvdouble__146_F_marginal_game_local, thisDotteamIndexOfPlayer_game_local, playerInGame, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_game_playerInGame_local);
								Gaussian[] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local2 = default(Gaussian[]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local2 = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_local[playerInGame];
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2[0] = ReplicateOp_NoDivide.UsesAverageConditional<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local2, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_game_playerInGame_local, 0, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2[0]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_marginal_game_playerInGame_local = ReplicateOp_Divide.Marginal<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_game_local[playerInGame], thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2[0], thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_marginal_game_playerInGame_local);
								...
								DistributionStructArray<Gaussian,double> thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_local2 = default(DistributionStructArray<Gaussian,double>);
								if (this.eventTypeCount>0) {
									thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_local2 = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_local[playerInGame];
								}
								...
								for(int eventType = 0; eventType<this.eventTypeCount; eventType++) {
									Gaussian thisDotvdouble366_F_game_playerInGame_eventType_local = default(Gaussian);
									Gaussian thisDotvdouble367_F_game_playerInGame_eventType_local = default(Gaussian);
									Gaussian thisDotvdouble370_F_game_playerInGame_eventType_local = default(Gaussian);
									Gaussian thisDotEventCountMean_F_game_playerInGame_eventType_local = default(Gaussian);
									Gaussian thisDotvdouble369_F_game_playerInGame_eventType_local = default(Gaussian);
									Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_game_playerInGame_eventType_local = Gaussian.Uniform();
									thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_game_playerInGame_eventType_local = ReplicateOp_Divide.UsesAverageConditional<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_game_playerInGame_local2[eventType], thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_marginal_game_playerInGame_local, eventType, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_game_playerInGame_eventType_local);
									thisDotvdouble369_F_game_playerInGame_eventType_local = GaussianProductOp_PointB.ProductAverageConditional(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_game_playerInGame_eventType_local, this.EventsPerMinuteEnemyMultiplier_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local2][eventType]);
									...
									thisDotvdouble366_F_game_playerInGame_eventType_local = GaussianProductOp_PointB.ProductAverageConditional(thisDotperformancesForEventsPrimary_rep_F_game_playerInGame_eventType_local, this.EventsPerMinutePerformanceMultiplier_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local2][eventType]);
									thisDotvdouble367_F_game_playerInGame_eventType_local = DoublePlusOp.SumAverageConditional(this.EventsPerMinuteOffset_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local2][eventType], thisDotvdouble366_F_game_playerInGame_eventType_local);
									thisDotvdouble370_F_game_playerInGame_eventType_local = DoublePlusOp.SumAverageConditional(thisDotvdouble367_F_game_playerInGame_eventType_local, thisDotvdouble369_F_game_playerInGame_eventType_local);
									thisDotEventCountMean_F_game_playerInGame_eventType_local = GaussianProductOpBase.ProductAverageConditional(thisDotvdouble370_F_game_playerInGame_eventType_local, thisDotminutesPlayed_game_playerInGame_local);
									...
									Gaussian thisDotvdouble370_B_game_playerInGame_eventType_local = default(Gaussian);
									Gaussian thisDotvdouble369_B_game_playerInGame_eventType_local = default(Gaussian);
									Gaussian thisDotenemyAverage_B_game_playerInGame_eventType_local = default(Gaussian);
									Gaussian thisDotvdouble367_B_game_playerInGame_eventType_local = default(Gaussian);
									Gaussian thisDotvdouble366_B_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble370_B_game_playerInGame_eventType_local = GaussianProductOpBase.AAverageConditional(thisDotEventCountMean_B_game_playerInGame_eventType_local, thisDotminutesPlayed_game_playerInGame_local);
									thisDotvdouble367_B_game_playerInGame_eventType_local = DoublePlusOp.AAverageConditional(thisDotvdouble370_B_game_playerInGame_eventType_local, thisDotvdouble369_F_game_playerInGame_eventType_local);
									thisDotvdouble366_B_game_playerInGame_eventType_local = DoublePlusOp.BAverageConditional(thisDotvdouble367_B_game_playerInGame_eventType_local, this.EventsPerMinuteOffset_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local2][eventType]);
									this.playerPerfCopy_B[game][playerInGame][eventType] = GaussianProductOp_PointB.AAverageConditional(thisDotvdouble366_B_game_playerInGame_eventType_local, this.EventsPerMinutePerformanceMultiplier_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local2][eventType]);
									thisDotvdouble369_B_game_playerInGame_eventType_local = DoublePlusOp.BAverageConditional(thisDotvdouble370_B_game_playerInGame_eventType_local, thisDotvdouble367_F_game_playerInGame_eventType_local);
									thisDotenemyAverage_B_game_playerInGame_eventType_local = GaussianProductOp_PointB.AAverageConditional(thisDotvdouble369_B_game_playerInGame_eventType_local, this.EventsPerMinuteEnemyMultiplier_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local2][eventType]);
								...
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2[1] = Gaussian.Uniform();
								Gaussian thisDotperformanceAdvantage_F_game_playerInGame_local = default(Gaussian);
								Gaussian thisDotvdouble386_F_game_playerInGame_local = default(Gaussian);
								...
								Bernoulli thisDotvbool34_B_game_playerInGame_local = default(Bernoulli);
								thisDotvbool34_B_game_playerInGame_local = BooleanOrOp.BAverageConditional(thisDotplayerQuitInGameFlat_game_local[playerInGame], thisDotdrop_F_game_playerInGame_local);
								Bernoulli thisDotlowPerformance_B_game_playerInGame_local = default(Bernoulli);
								thisDotlowPerformance_B_game_playerInGame_local = BooleanAndOp.BAverageConditional(thisDotvbool34_B_game_playerInGame_local, thisDotquit_F_game_playerInGame_local);
								Gaussian thisDotperformanceUnderThreshold_use_B_game_playerInGame_local = default(Gaussian);
								Gaussian thisDotvdouble386_B_game_playerInGame_local = default(Gaussian);
								...
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2[1] = ReplicateOp_NoDivide.UsesAverageConditional<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_game_playerInGame_local2, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_game_playerInGame_local, 1, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2[1]);
								...
								thisDotperformanceAdvantage_F_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotperformancesForQuit_F_game_playerInGame_local, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2[1]);
								...
								thisDotvdouble386_F_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotquitThreshold_thisDotplayerConditionsToLearnInGame_game_playerInGame_local, thisDotperformanceAdvantage_F_game_playerInGame_local);
								...
								thisDotperformanceUnderThreshold_F_game_playerInGame_local = GaussianOpBase.SampleAverageConditional(thisDotvdouble386_F_game_playerInGame_local, thisDotquitThresholdPrecision_thisDotplayerConditionsToLearnInGame_game_playerInGame_local);
								...
								thisDotvdouble386_B_game_playerInGame_local = GaussianOpBase.MeanAverageConditional(thisDotperformanceUnderThreshold_use_B_game_playerInGame_local, thisDotquitThresholdPrecision_thisDotplayerConditionsToLearnInGame_game_playerInGame_local);
								thisDotperformanceAdvantage_B_game_playerInGame_local = DoublePlusOp.BAverageConditional(thisDotquitThreshold_thisDotplayerConditionsToLearnInGame_game_playerInGame_local, thisDotvdouble386_B_game_playerInGame_local);
								this.playerPerfQuit_B[game][playerInGame] = DoublePlusOp.SumAverageConditional(thisDotperformanceAdvantage_B_game_playerInGame_local, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2[1]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_game_playerInGame_local2;
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								thisDotpredictedSkill2_B_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotskillsPresent_uses_F_game_local[playerInGame][0], thisDotvdouble247_F_game_local[playerInGame]);
								...
								if (!thisDotnoExperienceLastGameInConditions_game_playerInGame_local2) {
									Gaussian thisDotvdouble226_B_game_playerInGame_local = default(Gaussian);
									...
									thisDotvdouble226_B_game_playerInGame_local = GaussianOpBase.MeanAverageConditional(thisDotpredictedSkill2_B_game_playerInGame_local, this.skillOffsetChangePrecisionPerGame[thisDotplayerConditionsToLearnInGame_game_playerInGame_local3]);
									thisDotpredictedSkill1_use_B_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotvdouble226_B_game_playerInGame_local, this.skillOffsetChangeMeanByExperience[thisDotplayerConditionsToLearnInGame_game_playerInGame_local3][thisDotboundedExperienceForConditions_game_local[playerInGame]]);
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								for(int index16 = 0; index16<thisDotupdateChangeVariableSubarrayCountInGame_game_playerInGame_local2; index16++) {
									thisDotupdateChanges_B_game_playerInGame_local[index16] = Gaussian.Uniform();
								}
								thisDotupdateChanges_B_game_local[playerInGame] = thisDotupdateChanges_B_game_playerInGame_local;
							}
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian thisDotvdouble247_B_game_playerInGame_local = default(Gaussian);
								Gaussian thisDotbaseSkillChangeSinceLastGame_B_game_playerInGame_local = default(Gaussian);
								Gaussian thisDotvdouble231_B_game_playerInGame_local = default(Gaussian);
								thisDotvdouble231_B_game_playerInGame_local = Gaussian.Uniform();
								thisDotvdouble247_B_game_playerInGame_local = DoublePlusOp.BAverageConditional(thisDotskillsPresent_uses_F_game_local[playerInGame][0], thisDotpredictedSkill2_F_game_local[playerInGame]);
								thisDotbaseSkillChangeSinceLastGame_B_game_playerInGame_local = GaussianProductOpBase.AAverageConditional(thisDotvdouble247_B_game_playerInGame_local, this.baseSkillWeights[thisDotplayerConditionsToLearnInGame_game_local[playerInGame]]);
								...
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local4==4) {
									Gaussian thisDotvdouble231_4__B_game_playerInGame_local = default(Gaussian);
									...
									thisDotvdouble231_4__B_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotbaseSkillChangeSinceLastGame_B_game_playerInGame_local, thisDotupdateChanges_playerInGame_1_4__uses_F_game_playerInGame_local[1]);
									thisDotvdouble231_B_game_playerInGame_local = ArrayHelper.SetTo<Gaussian>(thisDotvdouble231_B_game_playerInGame_local, thisDotvdouble231_4__B_game_playerInGame_local);
								}
								Gaussian thisDotvdouble230_B_game_playerInGame_local = default(Gaussian);
								...
								for(int index15 = 0; index15<thisDotpreviousChangeVariableSubarrayCountInGame_game_playerInGame_local2; index15++) {
									thisDotpreviousChanges_B_game_playerInGame_local[index15] = Gaussian.Uniform();
								}
								...
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local4==0) {
									thisDotvdouble231_B_game_playerInGame_local = ArrayHelper.SetTo<Gaussian>(thisDotvdouble231_B_game_playerInGame_local, thisDotbaseSkillChangeSinceLastGame_B_game_playerInGame_local);
								}
								...
								Gaussian thisDotvdouble230_F_game_playerInGame_local2 = default(Gaussian);
								thisDotvdouble230_F_game_playerInGame_local2 = thisDotvdouble230_F_game_local[playerInGame];
								thisDotbaseSkillChangePrimary_B_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotvdouble231_B_game_playerInGame_local, thisDotvdouble230_F_game_playerInGame_local2);
								...
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local4==2) {
									Gaussian thisDotvdouble238_F_game_playerInGame_local = default(Gaussian);
									thisDotvdouble238_F_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotupdateChanges_item0_F_game_local[playerInGame], thisDotbaseSkillChangeSecondary_F_game_playerInGame_local);
									thisDotupdateChanges_item1_B_game_playerInGame_local = ArrayHelper.SetTo<Gaussian>(thisDotupdateChanges_item1_B_game_playerInGame_local, thisDotvdouble238_F_game_playerInGame_local);
								}
								...
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local4==4) {
									...
									Gaussian thisDotvdouble244_F_game_playerInGame_local = default(Gaussian);
									thisDotupdateChanges_playerInGame_1_4__uses_B_game_playerInGame_local2[1] = DoublePlusOp.BAverageConditional(thisDotbaseSkillChangeSinceLastGame_B_game_playerInGame_local, thisDotvdouble231_F_game_local[playerInGame]);
									...
									thisDotvdouble244_F_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotupdateChanges_F_game_playerInGame_local3[2], thisDotupdateChanges_playerInGame_1_4__uses_F_game_playerInGame_local[0]);
									...
									thisDotupdateChanges_B_game_playerInGame_local2[3] = ArrayHelper.SetTo<Gaussian>(thisDotupdateChanges_B_game_playerInGame_local2[3], thisDotvdouble244_F_game_playerInGame_local);
								}
								thisDotvdouble230_B_game_playerInGame_local = DoublePlusOp.BAverageConditional(thisDotvdouble231_B_game_playerInGame_local, thisDotbaseSkillChangePrimary_F_game_local[playerInGame]);
								thisDotpreviousChanges_B_game_playerInGame_local = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(thisDotvdouble230_B_game_playerInGame_local, thisDotvdouble230_F_game_playerInGame_local2, thisDotpreviousChanges_F_game_local[playerInGame], thisDotpreviousChanges_B_game_playerInGame_local);
                            ...
                            IList<Gaussian> a = thisDotskillsPast_B_game_local;
                            int b = this.playerCountInGame[game];
                            IList<Gaussian> c = thisDotskillsPresent_B_game_local;
						    DistributionStructArray<Gaussian, double> d = thisDotskillsPastAndPresent_B_game_local;

                            thisDotskillsPastAndPresent_B_game_local = SplitOp<double>.ArrayAverageConditional<DistributionStructArray<Gaussian,double>, Gaussian>(a, b, c, d);
				...
				for(int game_Block3 = GamesInBlock[0].Length-1; game_Block3>=0; game_Block3--) {
					Parallel.For(0, GamesInBlock.Length, delegate(int game_thread3) {
						for(int game_inBlock3 = GamesInBlock[game_thread3][game_Block3].Length-1; game_inBlock3>=0; game_inBlock3--) {
							...
							DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_local = default(DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>);
							thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_local = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.playerCountInGame[game]);
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								DistributionStructArray<Gaussian,double> thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_playerInGame_local = default(DistributionStructArray<Gaussian,double>);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_playerInGame_local = new DistributionStructArray<Gaussian,double>(this.eventTypeCount);
								for(int eventType = 0; eventType<this.eventTypeCount; eventType++) {
									Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_playerInGame_eventType_local = LowPriorityBackwardOp.ValueAverageConditional<Gaussian>(this.enemyAverageCopy_B[game][playerInGame][eventType]);
									thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_playerInGame_local[eventType] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_playerInGame_eventType_local;
								}
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_playerInGame_local;
							}
							Gaussian[][] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_local = default(Gaussian[][]);
							thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_local = new Gaussian[this.playerCountInGame[game]][];
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian[] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local = default(Gaussian[]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local = new Gaussian[2];
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local[0] = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local;
							}
							DistributionStructArray<Gaussian,double> thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_Rgame_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_Rgame_game_local = new DistributionStructArray<Gaussian,double>(this.playerCountInGame[game]);
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_Rgame_game_playerInGame_local = ReplicateOp_Divide.ToDefInit<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_local[playerInGame][0]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_Rgame_game_playerInGame_local = ReplicateOp_Divide.ToDef<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_local[playerInGame], thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_Rgame_game_playerInGame_local);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_Rgame_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_Rgame_game_playerInGame_local;
							}
							Gaussian[][] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_local = default(Gaussian[][]);
							thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_local = new Gaussian[this.playerCountInGame[game]][];
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian[] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local = default(Gaussian[]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local = new Gaussian[2];
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local[0] = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local[0] = ArrayHelper.SetTo<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local[0], thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_Rgame_game_local[playerInGame]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local[1] = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local[1] = LowPriorityBackwardOp.ValueAverageConditional<Gaussian>(this.enemyAverageQuit_B[game][playerInGame]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local;
							}
							DistributionStructArray<Gaussian,double> thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_local = new DistributionStructArray<Gaussian,double>(this.playerCountInGame[game]);
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_playerInGame_local = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_playerInGame_local = ReplicateOp_NoDivide.DefAverageConditional<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_local[playerInGame], thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_playerInGame_local);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_playerInGame_local;
							}
							...
							DistributionStructArray<Gaussian,double> thisDotvdouble__146_B_Rgame_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble__146_B_Rgame_game_local = new DistributionStructArray<Gaussian,double>(thisDotTeamCount_game_local2);
							for(int team = 0; team<thisDotTeamCount_game_local2; team++) {
								thisDotvdouble__146_B_Rgame_game_local[team] = Gaussian.Uniform();
							}
							thisDotvdouble__146_B_Rgame_game_local = GetItemsOp<double>.ArrayAverageConditional<Gaussian,DistributionStructArray<Gaussian,double>>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_local, thisDotteamIndexOfPlayer_Rgame_game_local, thisDotvdouble__146_B_Rgame_game_local);
							...
							for(int team = 0; team<thisDotTeamCount_game_local2; team++) {
								thisDotteamStrength2_rep_B_Rgame_game_local[team] = SumExceptOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(thisDotvdouble__146_B_Rgame_game_local[team], this.teamStrength2_rep_F[game][team], team, thisDotteamStrength2_rep_B_Rgame_game_local[team]);
							}
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								for(int index16 = 0; index16<thisDotupdateChangeVariableSubarrayCountInGame_game_playerInGame_local3; index16++) {
									thisDotupdateChanges_F_Rgame_game_playerInGame_local[index16] = Gaussian.Uniform();
								}
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								for(int index15 = 0; index15<thisDotpreviousChangeVariableSubarrayCountInGame_game_playerInGame_local3; index15++) {
									thisDotpreviousChanges_F_Rgame_game_playerInGame_local[index15] = Gaussian.Uniform();
								}
							...
							DistributionStructArray<Gaussian,double> thisDotvdouble230_F_Rgame_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble230_F_Rgame_game_local = new DistributionStructArray<Gaussian,double>(this.playerCountInGame[game]);
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian thisDotvdouble230_F_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble230_F_Rgame_game_playerInGame_local = FastSumOp.SumAverageConditional(thisDotpreviousChanges_F_Rgame_game_local[playerInGame]);
								thisDotvdouble230_F_Rgame_game_local[playerInGame] = thisDotvdouble230_F_Rgame_game_playerInGame_local;
							}
							DistributionStructArray<Gaussian,double> thisDotvdouble231_F_Rgame_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble231_F_Rgame_game_local = new DistributionStructArray<Gaussian,double>(this.playerCountInGame[game]);
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian thisDotvdouble231_F_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble231_F_Rgame_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotbaseSkillChangePrimary_F_Rgame_game_local[playerInGame], thisDotvdouble230_F_Rgame_game_local[playerInGame]);
								thisDotvdouble231_F_Rgame_game_local[playerInGame] = thisDotvdouble231_F_Rgame_game_playerInGame_local;
							}
							DistributionStructArray<Gaussian,double> thisDotvdouble247_F_Rgame_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble247_F_Rgame_game_local = new DistributionStructArray<Gaussian,double>(this.playerCountInGame[game]);
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								Gaussian thisDotvdouble231_F_Rgame_game_playerInGame_local2 = default(Gaussian);
								thisDotvdouble231_F_Rgame_game_playerInGame_local2 = thisDotvdouble231_F_Rgame_game_local[playerInGame];
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local8==0) {
									thisDotbaseSkillChangeSinceLastGame_F_Rgame_game_playerInGame_local = ArrayHelper.SetTo<Gaussian>(thisDotbaseSkillChangeSinceLastGame_F_Rgame_game_playerInGame_local, thisDotvdouble231_F_Rgame_game_playerInGame_local2);
								}
								...
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local8==4) {
									...
									thisDotbaseSkillChangeSinceLastGame_4__F_Rgame_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotvdouble231_F_Rgame_game_playerInGame_local2, thisDotupdateChanges_playerInGame_1_4__uses_F_Rgame_game_playerInGame__1_local);
								...
								Gaussian thisDotvdouble247_F_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble247_F_Rgame_game_playerInGame_local = GaussianProductOpBase.ProductAverageConditional(thisDotbaseSkillChangeSinceLastGame_F_Rgame_game_playerInGame_local, this.baseSkillWeights[thisDotplayerConditionsToLearnInGame_game_local2[playerInGame]]);
								thisDotvdouble247_F_Rgame_game_local[playerInGame] = thisDotvdouble247_F_Rgame_game_playerInGame_local;
							}
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								if (!thisDotnoExperienceLastGameInConditions_game_playerInGame_local3) {
									...
									Gaussian thisDotvdouble226_F_Rgame_game_playerInGame_local = default(Gaussian);
									thisDotvdouble226_F_Rgame_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotpredictedSkill1_F_Rgame_game_playerInGame_local, this.skillOffsetChangeMeanByExperience[thisDotplayerConditionsToLearnInGame_game_playerInGame_local4][thisDotboundedExperienceForConditions_Rgame_game_playerInGame_local]);
									Gaussian thisDotpredictedSkill2_1__F_Rgame_game_playerInGame_local = default(Gaussian);
									thisDotpredictedSkill2_1__F_Rgame_game_playerInGame_local = GaussianOpBase.SampleAverageConditional(thisDotvdouble226_F_Rgame_game_playerInGame_local, this.skillOffsetChangePrecisionPerGame[thisDotplayerConditionsToLearnInGame_game_playerInGame_local4]);
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								thisDotpredictedSkill_F_Rgame_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotpredictedSkill2_F_Rgame_game_local[playerInGame], thisDotvdouble247_F_Rgame_game_local[playerInGame]);
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								if (this.playerIsInSquad[game][playerInGame]) {
									...
									int thisDotvint147_Rgame_game_playerInGame_local = default(int);
									thisDotvint147_Rgame_game_playerInGame_local = Factor.Difference(this.squadSizeBucketCount[thisDotplayerConditionsToLearnInGame_game_playerInGame_local5], 1);
									...
									thisDotboundedSquadSize_Rgame_game_playerInGame_local = Math.Min(thisDotvint147_Rgame_game_playerInGame_local, thisDotSquadSizeMinus2_Rgame_game_playerInGame_local);
								}
							...
							for(int orderedTeam = 0; orderedTeam<thisDotTeamCount_game_local2; orderedTeam++) {
								...
								if (orderedTeam>0) {
									...
									if (thisDotdrawWithPreviousInGame_game_orderedTeam_local3) {
										double thisDotvdouble305_Rgame_game_orderedTeam_local = default(double);
										thisDotvdouble305_Rgame_game_orderedTeam_local = Factor.Difference(0.0, thisDotdrawMargin_thisDotdrawMarginConditionsInGame_game_local2);
										Gaussian thisDotPerformanceDifference_0__B_Rgame_game_orderedTeam_local = default(Gaussian);
										thisDotPerformanceDifference_0__B_Rgame_game_orderedTeam_local = DoubleIsBetweenOp.XAverageConditional(true, thisDotPerformanceDifference_F_Rgame_game_orderedTeam_local, thisDotvdouble305_Rgame_game_orderedTeam_local, thisDotdrawMargin_thisDotdrawMarginConditionsInGame_game_local2);
							...
							for(int orderedTeam = thisDotTeamCount_game_local2-1; orderedTeam>=0; orderedTeam--) {
								...
								if (orderedTeam>0) {
									...
									if (thisDotdrawWithPreviousInGame_game_orderedTeam_local4) {
										double thisDotvdouble305_Rgame_RorderedTeam_game_orderedTeam_local = default(double);
										thisDotvdouble305_Rgame_RorderedTeam_game_orderedTeam_local = Factor.Difference(0.0, thisDotdrawMargin_thisDotdrawMarginConditionsInGame_game_local2);
										Gaussian thisDotPerformanceDifference_0__B_Rgame_RorderedTeam_game_orderedTeam_local = default(Gaussian);
										thisDotPerformanceDifference_0__B_Rgame_RorderedTeam_game_orderedTeam_local = DoubleIsBetweenOp.XAverageConditional(true, thisDotPerformanceDifference_F_Rgame_RorderedTeam_game_orderedTeam_local, thisDotvdouble305_Rgame_RorderedTeam_game_orderedTeam_local, thisDotdrawMargin_thisDotdrawMarginConditionsInGame_game_local2);
							...
							DistributionStructArray<Gaussian,double> thisDotvdouble__146_F_Rgame_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble__146_F_Rgame_game_local = new DistributionStructArray<Gaussian,double>(thisDotTeamCount_game_local2);
							for(int team = 0; team<thisDotTeamCount_game_local2; team++) {
								thisDotvdouble__146_F_Rgame_game_local[team] = Gaussian.Uniform();
							}
							DistributionStructArray<Gaussian,double> thisDotvdouble__146_F_marginal_Rgame_game_local = default(DistributionStructArray<Gaussian,double>);
							thisDotvdouble__146_F_marginal_Rgame_game_local = GetItemsOp<double>.MarginalInit<DistributionStructArray<Gaussian,double>>(thisDotvdouble__146_F_Rgame_game_local);
							...
							for(int team = 0; team<thisDotTeamCount_game_local2; team++) {
								thisDotvdouble__146_F_Rgame_game_local[team] = SumExceptOp.SumExceptAverageConditional(this.teamStrength2_rep_F[game][team], team);
							}
							thisDotvdouble__146_F_marginal_Rgame_game_local = GetItemsOp<double>.Marginal<DistributionStructArray<Gaussian,double>,Gaussian>(thisDotvdouble__146_F_Rgame_game_local, thisDotvdouble__146_B_Rgame_game_local, thisDotvdouble__146_F_marginal_Rgame_game_local);
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								Gaussian[] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2 = default(Gaussian[]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2 = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_local[playerInGame];
								Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_marginal_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_marginal_Rgame_game_playerInGame_local = ReplicateOp_Divide.MarginalInit<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2[0]);
								Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_Rgame_game_playerInGame_local = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_Rgame_game_playerInGame_local = GetItemsOp<double>.ItemsAverageConditional<DistributionStructArray<Gaussian,double>,Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_local[playerInGame], thisDotvdouble__146_F_Rgame_game_local, thisDotvdouble__146_F_marginal_Rgame_game_local, thisDotteamIndexOfPlayer_Rgame_game_local, playerInGame, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_Rgame_game_playerInGame_local);
								Gaussian[] thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local2 = default(Gaussian[]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local2 = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_local[playerInGame];
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2[0] = ReplicateOp_NoDivide.UsesAverageConditional<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local2, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_Rgame_game_playerInGame_local, 0, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2[0]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_marginal_Rgame_game_playerInGame_local = ReplicateOp_Divide.Marginal<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_toDef_Rgame_game_local[playerInGame], thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2[0], thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_marginal_Rgame_game_playerInGame_local);
								...
								DistributionStructArray<Gaussian,double> thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_playerInGame_local2 = default(DistributionStructArray<Gaussian,double>);
								if (this.eventTypeCount>0) {
									thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_playerInGame_local2 = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_local[playerInGame];
								}
								...
								for(int eventType = 0; eventType<this.eventTypeCount; eventType++) {
									...
									Gaussian thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_Rgame_game_playerInGame_eventType_local = Gaussian.Uniform();
									thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_Rgame_game_playerInGame_eventType_local = ReplicateOp_Divide.UsesAverageConditional<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_B_Rgame_game_playerInGame_local2[eventType], thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_marginal_Rgame_game_playerInGame_local, eventType, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_Rgame_game_playerInGame_eventType_local);
									Gaussian thisDotvdouble369_F_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble369_F_Rgame_game_playerInGame_eventType_local = GaussianProductOp_PointB.ProductAverageConditional(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_Rgame_game_playerInGame_eventType_local, this.EventsPerMinuteEnemyMultiplier_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local6][eventType]);
									Gaussian thisDotvdouble366_F_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble366_F_Rgame_game_playerInGame_eventType_local = GaussianProductOp_PointB.ProductAverageConditional(thisDotperformancesForEventsPrimary_rep_F_Rgame_game_playerInGame_eventType_local, this.EventsPerMinutePerformanceMultiplier_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local6][eventType]);
									Gaussian thisDotvdouble367_F_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble367_F_Rgame_game_playerInGame_eventType_local = DoublePlusOp.SumAverageConditional(this.EventsPerMinuteOffset_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local6][eventType], thisDotvdouble366_F_Rgame_game_playerInGame_eventType_local);
									Gaussian thisDotvdouble370_F_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble370_F_Rgame_game_playerInGame_eventType_local = DoublePlusOp.SumAverageConditional(thisDotvdouble367_F_Rgame_game_playerInGame_eventType_local, thisDotvdouble369_F_Rgame_game_playerInGame_eventType_local);
									Gaussian thisDotEventCountMean_F_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotEventCountMean_F_Rgame_game_playerInGame_eventType_local = GaussianProductOpBase.ProductAverageConditional(thisDotvdouble370_F_Rgame_game_playerInGame_eventType_local, thisDotminutesPlayed_Rgame_game_playerInGame_local);
									...
									Gaussian thisDotvdouble370_B_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble370_B_Rgame_game_playerInGame_eventType_local = GaussianProductOpBase.AAverageConditional(thisDotEventCountMean_B_Rgame_game_playerInGame_eventType_local, thisDotminutesPlayed_Rgame_game_playerInGame_local);
									Gaussian thisDotvdouble367_B_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble367_B_Rgame_game_playerInGame_eventType_local = DoublePlusOp.AAverageConditional(thisDotvdouble370_B_Rgame_game_playerInGame_eventType_local, thisDotvdouble369_F_Rgame_game_playerInGame_eventType_local);
									Gaussian thisDotvdouble366_B_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble366_B_Rgame_game_playerInGame_eventType_local = DoublePlusOp.BAverageConditional(thisDotvdouble367_B_Rgame_game_playerInGame_eventType_local, this.EventsPerMinuteOffset_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local6][eventType]);
									this.playerPerfCopy_B[game][playerInGame][eventType] = GaussianProductOp_PointB.AAverageConditional(thisDotvdouble366_B_Rgame_game_playerInGame_eventType_local, this.EventsPerMinutePerformanceMultiplier_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local6][eventType]);
									Gaussian thisDotvdouble369_B_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotvdouble369_B_Rgame_game_playerInGame_eventType_local = DoublePlusOp.BAverageConditional(thisDotvdouble370_B_Rgame_game_playerInGame_eventType_local, thisDotvdouble367_F_Rgame_game_playerInGame_eventType_local);
									Gaussian thisDotenemyAverage_B_Rgame_game_playerInGame_eventType_local = default(Gaussian);
									thisDotenemyAverage_B_Rgame_game_playerInGame_eventType_local = GaussianProductOp_PointB.AAverageConditional(thisDotvdouble369_B_Rgame_game_playerInGame_eventType_local, this.EventsPerMinuteEnemyMultiplier_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local6][eventType]);
									...
									this.EventsPerMinutePerformanceMultiplier_itemPlayerConditionsToLearnInGame_game__playerInGame__B[game][playerInGame][eventType] = GaussianProductOp_PointB.BAverageConditional(thisDotvdouble366_B_Rgame_game_playerInGame_eventType_local, thisDotperformancesForEventsPrimary_rep_F_Rgame_game_playerInGame_eventType_local, this.EventsPerMinutePerformanceMultiplier_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local6][eventType]);
									this.EventsPerMinuteOffset_itemPlayerConditionsToLearnInGame_game__playerInGame__B[game][playerInGame][eventType] = DoublePlusOp.AAverageConditional(thisDotvdouble367_B_Rgame_game_playerInGame_eventType_local, thisDotvdouble366_F_Rgame_game_playerInGame_eventType_local);
									this.EventsPerMinuteEnemyMultiplier_itemPlayerConditionsToLearnInGame_game__playerInGame__B[game][playerInGame][eventType] = GaussianProductOp_PointB.BAverageConditional(thisDotvdouble369_B_Rgame_game_playerInGame_eventType_local, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__rep_F_Rgame_game_playerInGame_eventType_local, this.EventsPerMinuteEnemyMultiplier_marginal_F[thisDotplayerConditionsToLearnInGame_game_playerInGame_local6][eventType]);
								}
								this.performancesForEventsPrimary_rep_B_toDef[game][playerInGame] = ReplicateOp_Divide.ToDef<Gaussian>(this.playerPerfCopy_B[game][playerInGame], this.performancesForEventsPrimary_rep_B_toDef[game][playerInGame]);
								...
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2[1] = Gaussian.Uniform();
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2[1] = ReplicateOp_NoDivide.UsesAverageConditional<Gaussian>(thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_B_Rgame_game_playerInGame_local2, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__F_Rgame_game_playerInGame_local, 1, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2[1]);
								...
								thisDotperformanceAdvantage_F_Rgame_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotperformancesForQuit_F_Rgame_game_playerInGame_local, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2[1]);
								Gaussian thisDotvdouble386_F_Rgame_game_playerInGame_local = default(Gaussian);
								...
								thisDotvdouble386_F_Rgame_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotquitThreshold_thisDotplayerConditionsToLearnInGame_game_playerInGame_local2, thisDotperformanceAdvantage_F_Rgame_game_playerInGame_local);
								...
								thisDotperformanceUnderThreshold_F_Rgame_game_playerInGame_local = GaussianOpBase.SampleAverageConditional(thisDotvdouble386_F_Rgame_game_playerInGame_local, thisDotquitThresholdPrecision_thisDotplayerConditionsToLearnInGame_game_playerInGame_local2);
								...
								Bernoulli thisDotvbool34_B_Rgame_game_playerInGame_local = default(Bernoulli);
								thisDotvbool34_B_Rgame_game_playerInGame_local = BooleanOrOp.BAverageConditional(thisDotplayerQuitInGameFlat_game_local2[playerInGame], thisDotdrop_F_Rgame_game_playerInGame_local);
								Bernoulli thisDotlowPerformance_B_Rgame_game_playerInGame_local = default(Bernoulli);
								thisDotlowPerformance_B_Rgame_game_playerInGame_local = BooleanAndOp.BAverageConditional(thisDotvbool34_B_Rgame_game_playerInGame_local, thisDotquit_F_Rgame_game_playerInGame_local);
								...
								Gaussian thisDotvdouble386_B_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble386_B_Rgame_game_playerInGame_local = GaussianOpBase.MeanAverageConditional(thisDotperformanceUnderThreshold_use_B_Rgame_game_playerInGame_local, thisDotquitThresholdPrecision_thisDotplayerConditionsToLearnInGame_game_playerInGame_local2);
								Gaussian thisDotperformanceAdvantage_B_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotperformanceAdvantage_B_Rgame_game_playerInGame_local = DoublePlusOp.BAverageConditional(thisDotquitThreshold_thisDotplayerConditionsToLearnInGame_game_playerInGame_local2, thisDotvdouble386_B_Rgame_game_playerInGame_local);
								this.playerPerfQuit_B[game][playerInGame] = DoublePlusOp.SumAverageConditional(thisDotperformanceAdvantage_B_Rgame_game_playerInGame_local, thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2[1]);
								thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_local[playerInGame] = thisDotvdouble__146_itemteamIndexOfPlayer_game__playerInGame__uses_F_Rgame_game_playerInGame_local2;
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								thisDotpredictedSkill2_B_Rgame_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotskillsPresent_uses_F_Rgame_game_local[playerInGame][0], thisDotvdouble247_F_Rgame_game_local[playerInGame]);
								...
								if (!thisDotnoExperienceLastGameInConditions_game_playerInGame_local4) {
									Gaussian thisDotvdouble226_B_Rgame_game_playerInGame_local = default(Gaussian);
									...
									thisDotvdouble226_B_Rgame_game_playerInGame_local = GaussianOpBase.MeanAverageConditional(thisDotpredictedSkill2_B_Rgame_game_playerInGame_local, this.skillOffsetChangePrecisionPerGame[thisDotplayerConditionsToLearnInGame_game_playerInGame_local7]);
									Gaussian thisDotpredictedSkill1_use_B_Rgame_game_playerInGame_local = default(Gaussian);
									thisDotpredictedSkill1_use_B_Rgame_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotvdouble226_B_Rgame_game_playerInGame_local, this.skillOffsetChangeMeanByExperience[thisDotplayerConditionsToLearnInGame_game_playerInGame_local7][thisDotboundedExperienceForConditions_Rgame_game_local[playerInGame]]);
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								...
								for(int index16 = 0; index16<thisDotupdateChangeVariableSubarrayCountInGame_game_playerInGame_local4; index16++) {
									thisDotupdateChanges_B_Rgame_game_playerInGame_local[index16] = Gaussian.Uniform();
								}
							...
							for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
								Gaussian thisDotvdouble247_B_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble247_B_Rgame_game_playerInGame_local = DoublePlusOp.BAverageConditional(thisDotskillsPresent_uses_F_Rgame_game_local[playerInGame][0], thisDotpredictedSkill2_F_Rgame_game_local[playerInGame]);
								Gaussian thisDotbaseSkillChangeSinceLastGame_B_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotbaseSkillChangeSinceLastGame_B_Rgame_game_playerInGame_local = GaussianProductOpBase.AAverageConditional(thisDotvdouble247_B_Rgame_game_playerInGame_local, this.baseSkillWeights[thisDotplayerConditionsToLearnInGame_game_local2[playerInGame]]);
								Gaussian thisDotvdouble231_B_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble231_B_Rgame_game_playerInGame_local = Gaussian.Uniform();
								...
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local9==0) {
									thisDotvdouble231_B_Rgame_game_playerInGame_local = ArrayHelper.SetTo<Gaussian>(thisDotvdouble231_B_Rgame_game_playerInGame_local, thisDotbaseSkillChangeSinceLastGame_B_Rgame_game_playerInGame_local);
								}
								...
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local9==4) {
									Gaussian thisDotvdouble231_4__B_Rgame_game_playerInGame_local = default(Gaussian);
									...
									thisDotvdouble231_4__B_Rgame_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotbaseSkillChangeSinceLastGame_B_Rgame_game_playerInGame_local, thisDotupdateChanges_playerInGame_1_4__uses_F_Rgame_game_playerInGame_local[1]);
									thisDotvdouble231_B_Rgame_game_playerInGame_local = ArrayHelper.SetTo<Gaussian>(thisDotvdouble231_B_Rgame_game_playerInGame_local, thisDotvdouble231_4__B_Rgame_game_playerInGame_local);
								}
								Gaussian thisDotvdouble230_B_Rgame_game_playerInGame_local = default(Gaussian);
								thisDotvdouble230_B_Rgame_game_playerInGame_local = DoublePlusOp.BAverageConditional(thisDotvdouble231_B_Rgame_game_playerInGame_local, thisDotbaseSkillChangePrimary_F_Rgame_game_local[playerInGame]);
								...
								for(int index15 = 0; index15<thisDotpreviousChangeVariableSubarrayCountInGame_game_playerInGame_local4; index15++) {
									thisDotpreviousChanges_B_Rgame_game_playerInGame_local[index15] = Gaussian.Uniform();
								}
								Gaussian thisDotvdouble230_F_Rgame_game_playerInGame_local2 = default(Gaussian);
								thisDotvdouble230_F_Rgame_game_playerInGame_local2 = thisDotvdouble230_F_Rgame_game_local[playerInGame];
								thisDotpreviousChanges_B_Rgame_game_playerInGame_local = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(thisDotvdouble230_B_Rgame_game_playerInGame_local, thisDotvdouble230_F_Rgame_game_playerInGame_local2, thisDotpreviousChanges_F_Rgame_game_local[playerInGame], thisDotpreviousChanges_B_Rgame_game_playerInGame_local);
								...
								thisDotbaseSkillChangePrimary_B_Rgame_game_playerInGame_local = DoublePlusOp.AAverageConditional(thisDotvdouble231_B_Rgame_game_playerInGame_local, thisDotvdouble230_F_Rgame_game_playerInGame_local2);
								...
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local9==2) {
									Gaussian thisDotvdouble238_F_Rgame_game_playerInGame_local = default(Gaussian);
									thisDotvdouble238_F_Rgame_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotupdateChanges_item0_F_Rgame_game_local[playerInGame], thisDotbaseSkillChangeSecondary_F_Rgame_game_playerInGame_local);
									thisDotupdateChanges_item1_B_Rgame_game_playerInGame_local = ArrayHelper.SetTo<Gaussian>(thisDotupdateChanges_item1_B_Rgame_game_playerInGame_local, thisDotvdouble238_F_Rgame_game_playerInGame_local);
								}
								if (thisDotupdateChangeVariableCountInGame_game_playerInGame_local9==4) {
									...
									thisDotupdateChanges_playerInGame_1_4__uses_B_Rgame_game_playerInGame_local2[1] = DoublePlusOp.BAverageConditional(thisDotbaseSkillChangeSinceLastGame_B_Rgame_game_playerInGame_local, thisDotvdouble231_F_Rgame_game_local[playerInGame]);
									...
									Gaussian thisDotvdouble244_F_Rgame_game_playerInGame_local = default(Gaussian);
									thisDotvdouble244_F_Rgame_game_playerInGame_local = DoublePlusOp.SumAverageConditional(thisDotupdateChanges_F_Rgame_game_playerInGame_local3[2], thisDotupdateChanges_playerInGame_1_4__uses_F_Rgame_game_playerInGame_local[0]);
									...
									thisDotupdateChanges_B_Rgame_game_playerInGame_local2[3] = ArrayHelper.SetTo<Gaussian>(thisDotupdateChanges_B_Rgame_game_playerInGame_local2[3], thisDotvdouble244_F_Rgame_game_playerInGame_local);
								}
								if ((thisDotupdateChangeVariableCountInGame_game_playerInGame_local9==2)||(thisDotupdateChangeVariableCountInGame_game_playerInGame_local9==4)) {
						...
						for(int orderedTeam = 0; orderedTeam<thisDotTeamCount_game_local3; orderedTeam++) {
							if (orderedTeam>0) {
								if (thisDotdrawWithPreviousInGame_game_local3[orderedTeam]) {
									bool thisDotvbool18_game_orderedTeam_local = default(bool);
									thisDotvbool18_game_orderedTeam_local = true;
									Constrain.Equal<bool>(true, thisDotvbool18_game_orderedTeam_local);
								}
							}
						}
						for(int orderedTeam = 0; orderedTeam<thisDotTeamCount_game_local3; orderedTeam++) {
							if (orderedTeam>0) {
								if (!thisDotdrawWithPreviousInGame_game_local3[orderedTeam]) {
									bool thisDotvbool20_game_orderedTeam_local = default(bool);
									thisDotvbool20_game_orderedTeam_local = true;
									Constrain.Equal<bool>(true, thisDotvbool20_game_orderedTeam_local);
								}
							}
						}
					}
		...
		private void Changed_EventTypeCount_PlayerConditionsCount()
		{
			...
			if (this.playerConditionsCount>0) {
				if (this.eventTypeCount>0) {
					this.vbool____3_reduced = true;
					Constrain.Equal<bool>(true, this.vbool____3_reduced);
				}
			}
				...
				Parallel.For(0, GamesInBlock.Length, delegate(int game_thread11) {
					for(int game_inBlock11 = 0; game_inBlock11<GamesInBlock[game_thread11][game_Block11].Length; game_inBlock11++) {
						...
						for(int playerInGame = 0; playerInGame<this.playerCountInGame[game]; playerInGame++) {
							...
							bool thisDotvbool35_game_playerInGame_local = default(bool);
							thisDotvbool35_game_playerInGame_local = thisDotplayerQuitInGameFlat_game_playerInGame_local;
							Constrain.Equal<bool>(thisDotplayerQuitInGameFlat_game_playerInGame_local, thisDotvbool35_game_playerInGame_local);
						}
					}
				});
			}
			...
			for(int game_Block12 = 0; game_Block12<GamesInBlock[0].Length; game_Block12++) {
				Parallel.For(0, GamesInBlock.Length, delegate(int game_thread12) {
					for(int game_inBlock12 = 0; game_inBlock12<GamesInBlock[game_thread12][game_Block12].Length; game_inBlock12++) {
						...
						double thisDotvdouble319_game_local = default(double);
						thisDotvdouble319_game_local = Factor.Sum(thisDotteamWeight_game_local);
						for(int team = 0; team<thisDotTeamCount_game_local5; team++) {
							this.enemyWeight[game][team] = Factor.Difference(thisDotvdouble319_game_local, thisDotteamWeight_game_local[team]);
							bool thisDotvbool22_game_team_local = default(bool);
							thisDotvbool22_game_team_local = Factor.IsPositive(this.enemyWeight[game][team]);
							this.denomIsZero[game][team] = Factor.Not(thisDotvbool22_game_team_local);
						}
