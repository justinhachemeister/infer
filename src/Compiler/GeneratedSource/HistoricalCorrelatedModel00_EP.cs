					...
					for(int game_Block4 = 0; game_Block4<GamesInBlock[game_Block3][0].Length; game_Block4++) {
						Parallel.For(0, GamesInBlock[game_Block3].Length, delegate(int game_thread2) {
							for(int game_inBlock2 = 0; game_inBlock2<GamesInBlock[game_Block3][game_thread2][game_Block4].Length; game_inBlock2++) {
								...
								thisDotvdouble__620_B_game_local = GetItemsOp<double>.ArrayAverageConditional(thisDotvdouble__620_itemteamIndexOfPlayer_game__playerInGame__B_game_local, thisDotteamIndexOfPlayer_game_local, thisDotvdouble__620_B_game_local);
								for(int team = 0; team<thisDotTeamCount_game_local; team++) {
					...
					for(int game_Block6 = GamesInBlock[game_Block5][0].Length-1; game_Block6>=0; game_Block6--) {
						Parallel.For(0, GamesInBlock[game_Block5].Length, delegate(int game_thread3) {
							for(int game_inBlock3 = GamesInBlock[game_Block5][game_thread3][game_Block6].Length-1; game_inBlock3>=0; game_inBlock3--) {
								...
								thisDotvdouble__620_B_Rgame_game_local = GetItemsOp<double>.ArrayAverageConditional(thisDotvdouble__620_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_local, thisDotteamIndexOfPlayer_Rgame_game_local, thisDotvdouble__620_B_Rgame_game_local);
