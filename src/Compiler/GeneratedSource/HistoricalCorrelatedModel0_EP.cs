				...
				for(int game_Block2 = 0; game_Block2<GamesInBlock[0].Length; game_Block2++) {
					Parallel.For(0, GamesInBlock.Length, delegate(int game_thread2) {
						for(int game_inBlock2 = 0; game_inBlock2<GamesInBlock[game_thread2][game_Block2].Length; game_inBlock2++) {
							...
							thisDotvdouble__304_B_game_local = GetItemsOp<double>.ArrayAverageConditional<Gaussian,DistributionStructArray<Gaussian,double>>(thisDotvdouble__304_itemteamIndexOfPlayer_game__playerInGame__B_game_local, thisDotteamIndexOfPlayer_game_local, thisDotvdouble__304_B_game_local);
				...
				for(int game_Block3 = GamesInBlock[0].Length-1; game_Block3>=0; game_Block3--) {
					Parallel.For(0, GamesInBlock.Length, delegate(int game_thread3) {
						for(int game_inBlock3 = GamesInBlock[game_thread3][game_Block3].Length-1; game_inBlock3>=0; game_inBlock3--) {
							...
							thisDotvdouble__304_B_Rgame_game_local = GetItemsOp<double>.ArrayAverageConditional<Gaussian,DistributionStructArray<Gaussian,double>>(thisDotvdouble__304_itemteamIndexOfPlayer_game__playerInGame__B_Rgame_game_local, thisDotteamIndexOfPlayer_Rgame_game_local, thisDotvdouble__304_B_Rgame_game_local);
